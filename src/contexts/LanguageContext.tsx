...
const translations = {
  ar: {
    ...
    'driver.benefits.title': 'لماذا تنضم إلى ساريان؟',
    'driver.benefits.hours.title': 'ساعات عمل مرنة',
    'driver.benefits.hours.desc': 'اختر متى وأين تريد العمل بكامل الحرية.',
    'driver.benefits.income.title': 'أرباح أسبوعية',
    'driver.benefits.income.desc': 'احصل على مستحقاتك كل أسبوع دون تأخير.',
    'driver.benefits.support.title': 'دعم فني',
    'driver.benefits.support.desc': 'نحن معك على مدار الساعة لحل أي مشكلة تواجهك.',
    'driver.benefits.insurance.title': 'تأمين',
    'driver.benefits.insurance.desc': 'نوفر تغطية تأمينية لمندوبينا لضمان سلامتهم.',
    'driver.requirements.title': 'كل ما تحتاجه',
    'driver.requirements.phone': 'هاتف ذكي (Android/iOS)',
    'driver.requirements.vehicle': 'دراجة نارية أو سيارة',
    'driver.requirements.internet': 'اتصال دائم بالإنترنت',
    'driver.form.title': 'نموذج التسجيل الأولي ',
    'driver.form.desc': 'هل ترغب في الانضمام لفريق ساريان؟ املأ النموذج التالي وسنتواصل معك في أقرب وقت ممكن:',
    'driver.form.email': 'البريد الإلكتروني',
    'driver.form.phone': 'رقم الهاتف',
    'driver.form.city': 'المدينة',
    'driver.form.vehicleType': 'نوع المركبة',
    'driver.form.license': 'هل تتوفر على رخصة سياقة؟',
    'driver.form.insurance': 'هل تتوفر على تأمين للمركبة؟',
    'driver.form.yes': 'نعم',
    'driver.form.no': 'لا',
    'driver.form.submit': 'ارسل الان',
    'driver.contact.email': 'تواصل معنا عبر البريد: driver@sarian.ma',
  ...
  en: {
    ...
    'driver.benefits.title': 'Why join SARIAN?',
    'driver.benefits.hours.title': 'Flexible working hours',
    'driver.benefits.hours.desc': 'Choose when and where you want to work with full freedom.',
    'driver.benefits.income.title': 'Weekly earnings',
    'driver.benefits.income.desc': 'Get your payments every week without delay.',
    'driver.benefits.support.title': 'Technical support',
    'driver.benefits.support.desc': 'We are with you 24/7 to solve any problem you encounter.',
    'driver.benefits.insurance.title': 'Insurance',
    'driver.benefits.insurance.desc': 'We provide insurance coverage for our drivers to ensure their safety.',
    'driver.requirements.title': 'Everything you need',
    'driver.requirements.phone': 'Smartphone (Android/iOS)',
    'driver.requirements.vehicle': 'Motorcycle or Car',
    'driver.requirements.internet': 'Constant internet connection',
    'driver.form.title': 'Driver Preliminary Registration Form',
    'driver.form.desc': 'Do you want to join the Sarian team? Fill out the following form and we will contact you as soon as possible:',
    'driver.form.email': 'Email address',
    'driver.form.phone': 'Phone number',
    'driver.form.city': 'City',
    'driver.form.vehicleType': 'Vehicle type',
    'driver.form.license': 'Do you have a driver\'s license?',
    'driver.form.insurance': 'Do you have vehicle insurance?',
    'driver.form.yes': 'Yes',
    'driver.form.no': 'No',
    'driver.form.submit': 'Send Now',
    'driver.contact.email': 'Contact us via email: driver@sarian.ma',
    'driver.contact.app': 'Contact us via support inside the app',
  },
};
